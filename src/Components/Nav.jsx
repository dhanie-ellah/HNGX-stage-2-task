...
const Nav = () => {
  return (
    <div className=' flex justify-between items-center'>
      ...
      <form className=' bg-transparent border rounded-md p-[0.45rem] px-[2rem] w-[50%] flex items-center justify-between'>
        <input
          type="search"
          name="searchBar"
          id="searchBar"
      ...
      <div className=' flex items-center gap-[0.5rem]'>
        ...
        <FontAwesomeIcon icon={faBars} className=' bg-rose rounded-full text-white p-[0.5rem]'/>
      </div>
    </div>
  );
}
